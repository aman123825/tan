...
Future<void> main() async {
  ...
  final hasPreview = (Uri.base.queryParameters['preview'] ?? '').isNotEmpty;
...
class HearBloomColors {
  // Core brand
  static const Color seed = Color(0xff187a6d);
  static const Color primary = Color(0xff2aa889);
  static const Color primaryGlow = Color(0x442aa889);
  static const Color secondary = Color(0xffe76f51);
  static const Color accent = Color(0xff4d9de0);

  // Surfaces — glassmorphic
  static const Color background = Color(0xff111614);
  static const Color surface = Color(0x12ffffff);
  static const Color surfaceSolid = Color(0xff1b2320);
  static const Color card = Color(0x12ffffff);
  static const Color border = Color(0x2effffff);
  static const Color borderGlow = Color(0x442aa889);

  // Text
  static const Color ink = Color(0xfff3f6f2);
  static const Color inkSoft = Color(0xffa9b4ad);
  static const Color inkMuted = Color(0xff89958e);
  ...
  static const LinearGradient heroGradient = LinearGradient(
    ...
    colors: [Color(0xff1f5f55), Color(0xff18201d), Color(0xff3b2925)],
  );
  ...
  static const LinearGradient accentGradient = LinearGradient(
    ...
    colors: [Color(0xff2aa889), Color(0xffe76f51)],
  );
}
...
class HearBloomApp extends StatelessWidget {
  ...
  Widget _buildApp(AppSettings settings) {
    ...
    final Color border = hc ? const Color(0x66ffffff) : HearBloomColors.border;
                  ...
                  outlinedButtonTheme: OutlinedButtonThemeData(
                    style: OutlinedButton.styleFrom(
                      ...
                      foregroundColor: ink,
                        ...
                        side: focusOutline(base: BorderSide(color: border))),
                  ),
...
ThemeData buildLightTheme({bool highContrast = false}) {
  final Color ink =
      highContrast ? const Color(0xff000000) : const Color(0xff0f172a);
  final Color inkSoft =
